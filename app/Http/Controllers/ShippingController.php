...
class ShippingController extends Controller
{
    ...
    {
        $data['menu'] = 'sales';
        $data['sub_menu'] = 'shipping/cost';
        $data['salesData'] = $this->order->getAllSalseOrder(NULL, NULL, NULL, NULL, NULL);
        

        $data['shippingData'] = DB::table('shipping_cost')->get();
        return view('admin.shipping.shippingList', $data);
    }
...
//d(SALESORDER,1);
        ...
        $custquoteId = \DB::table('quote_cust_info')->insertGetId($quote_cust_info);
        ...
        // create salesOrder 
        $salesOrder['debtor_no'] = 'quote_name';
        $salesOrder['branch_id'] = 'quote_branch';
        $salesOrder['payment_id']= 'payment_id';
...
//d(SALESORDER,1);
    ...
    public function edit($orderNo)
    {
        ...
        return view('admin.quote.orderEdit', $data);
    }
