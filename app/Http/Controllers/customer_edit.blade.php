                  ...
                  <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-7">
                              <input type="text" placeholder="{{ trans('message.table.phone') }}" class="form-control valdation_check" id="name" name="channelid" value="{{$customerData->channel_id}}">
                              <span id="val_name" style="color: red"></span>
                            </div>
                          </div>
						  ...
						  <div class="form-group">
                            ...
                            <div class="col-sm-7">
                              <input type="text" placeholder="{{ trans('message.table.phone') }}" class="form-control valdation_check" id="name" name="channel" value="">
                              <span id="val_name" style="color: red"></span>
                            </div>
                          </div>
