      ...
      <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">Select Customer (by phone) or Create New<span class="text-danger"> *</span></label>
		...
		<div class="form-horizontal col-md-4" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9"> 
              <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter Phone No." readonly>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-3" for="email">Channel:</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="channel"  name="channel" placeholder="Enter Channel" readonly>
            </div>
          </div>
          <div class="form-group">
              ...
              if(!in_array(e.id, stack))
              {
                ...
                var new_row = '<tr id="rowid'+e.id+'">'+
                          ...
                          '<td class="text-center"><input min="0"  type="text" class="form-control text-center unitprice" name="unit_price[]" data-id = "'+e.id+'" id="rate_id_'+e.id+'" value="'+ e.price +'"></td>'+
                           ...
                           //weight div
                           '<input class="form-control text-center weight" type="hidden"  id="weight_'+e.id+'" value="'+e.weight +' gm'+'" name="item_weight[]" readonly>'+

                            '<input class="form-control text-center total_weight" type="hidden"  id="ttl_weight_'+e.id+'" value="'+e.ttlweight +' gm'+'" name="" readonly>'+
                            //end of weight div
