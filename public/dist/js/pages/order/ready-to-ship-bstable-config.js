var $ready_to_ship_table = $("#ready_to_ship_table");
function initReadyToShipTable(){
    $("#ready_to_ship_table").bootstrapTable({
        columns: [
            {
                field: 'state',
                checkbox: true,
...
$ready_to_ship_table.on('expand-row.bs.table', function (e, index, row, $detail) {
...
$ready_to_ship_table.on('check.bs.table uncheck.bs.table ' +
