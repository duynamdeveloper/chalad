...
<body>
  ...
  <div style="font-size:30px; font-weight:bold;clear:both">Invoice</div>
    ...
    <div style="width:300px; float:left;">
      <div style="margin-top:10px; margin-bottom:15px;">
        ...
        <div style="font-size:16px; font-weight:bold;">Invoice No # {{$saleDataInvoice->reference}}</div>
        <div style="font-size:16px;">Invocie Date : {{formatDate($saleDataInvoice->ord_date)}}</div>
        <div style="font-size:16px;">Due Date : {{formatDate($due_date)}}</div>
      
        @if($saleDataInvoice->paid_amount == 0)
          <div style="font-size:16px;" >Status : Unpaid</div>
        @elseif($saleDataInvoice->paid_amount > 0 && $saleDataInvoice->total > $saleDataInvoice->paid_amount )
          <div style="font-size:16px;" >Status : Partially paid</div>
        @elseif($saleDataInvoice->paid_amount<=$saleDataInvoice->paid_amount)
          <div style="font-size:16px;" >Status : Paid</div>
        @endif
  ...
  <div style="clear:both"></div>
    <div style="background-color:#323a45; padding:10px 20px;height:20px">
      ...
      <div style="width:100px; color:#FFFFFF; float:left; font-weight:bold; text-align:center">Price({{$currency->symbol}})</div>
      ...
      <div style="width:200px; color:#FFFFFF; float:left; font-weight:bold; text-align:right">Amount({{$currency->symbol}})</div>
      <div style="clear:both"></div>
    </div>
  <?php
    $taxAmount      = 0;
...
<div style="clear:both"></div>
  ...
  @endforeach  
    ...
    <div style="padding:0px 20px; ">
      ...
      <div style="width:150px; text-align:right; font-size:14px; float:left;font-weight:bold;">{{ $currency->symbol.number_format($subTotalAmount,2,'.',',') }}</div>
    </div>
    ...
    <div style="padding:0px 20px; ">
      ...
      <div style="width:150px; text-align:right; font-size:14px; float:left; ">{{ $currency->symbol.number_format($tax_amount,2,'.',',') }}</div>
    </div>
    <?php
    ...
    <div style="padding:0px 20px; ">
      ...
      <div style="width:150px; text-align:right; font-size:14px; float:left; font-weight:bold;">{{ $currency->symbol.number_format(($subTotalAmount+$taxAmount),2,'.',',') }}</div>
    </div>

    <div style="clear:both"></div>
    <div style="padding:0px 20px; ">
      <div style="width:460px; float:left; font-size:14px; text-align:right;">&nbsp;</div>
      <div style="width:250px; text-align:right; font-size:14px; float:left;">Paid Amount</div>
      <div style="width:150px; text-align:right; font-size:14px; float:left;">{{ Session::get('currency_symbol').number_format(($saleDataInvoice->paid_amount),2,'.',',') }}</div>
    </div>
    ...
    <div style="padding:0px 20px; ">
      <div style="width:460px; float:left; font-size:14px; text-align:right;">&nbsp;</div>
      <div style="width:250px; text-align:right; font-size:14px; float:left; font-weight:bold;">Due Amount</div>
      <div style="width:150px; text-align:right; font-size:14px; float:left; font-weight:bold;">{{ Session::get('currency_symbol').number_format(($subTotalAmount+$taxAmount-$saleDataInvoice->paid_amount),2,'.',',') }}</div>
    </div>
