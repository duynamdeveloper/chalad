      ...
      <div class="box-body">
        <div class="row ">
          <div class="col-md-12 ">
           ...
           <strong>{{ trans('message.extra_text.quote_pending') }}</strong>
           @elseif($quote_cust_info[0]->status==1)
            <div class="top-bar-title btn-success text-center padding-bottom">
           <strong>{{trans('message.extra_text.quote_approve')}}</strong>
           @endif
           </div>
          </div> 
          <div class="col-md-2">
...
<div class="col-md-12">
                          ...
                          <div class="col-md-6">    
<div class=""><h4 style="margin-top: -6px;"><strong>Customer Detail</strong></h4></div>						  
                          ...
                          <div class="col-md-6">
                              <div class="top-bar-title padding-bottom">
                                 <h4><strong>{{ trans('message.invoice.shipping_address') }}</strong></h4>
