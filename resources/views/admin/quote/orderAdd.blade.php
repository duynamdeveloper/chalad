            ...
            <div class="col-md-12">
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                  ...
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.invoice.is_vat') }}</strong></td><td align="left" colspan="2"><input type="checkbox" name="is_vat" id="is_vat"></td></tr>
          ...
          if(e.id) {
              if(!in_array(e.id, stack))
              {
                ...
                var new_row = '<tr id="rowid'+e.id+'">'+
                          ...
                          '<td class="text-center"><input class="form-control text-center" name="curr_stock[]" value=""/></td>'+
