...
@section('content')
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form action="{{url('quote/save')}}" method="POST" id="salesForm">  
        ...
        <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <div class="col-md-12">
                  <input class="form-control" name="phone" id="search_mobile" autocomplete="off" placeholder="{{ trans('message.table.seach_phone') }}">
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <div class="col-md-12">
                  <a id="add_new_customer" class="btn btn-block btn-default btn-flat btn-border-orange"><span class="fa fa-plus"> &nbsp;</span>{{ trans('message.form.add_new_customer') }}</a>
            ...
            <div class="col-md-12">
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                  ...
                  <tr class="tableInfo"><td colspan="5" align="right"><strong>{{ trans('message.table.sub_total') }}({{Session::get('currency_symbol')}})</strong></td><td align="left" colspan="2"><strong id="subTotal"></strong></td></tr>
                  
                  <tr class="tableInfo"><td colspan="5" align="right"><strong>{{ trans('message.invoice.is_vat') }}</strong></td><td align="left" colspan="2"><input type="checkbox" name="is_vat" id="is_vat"></td></tr>

                 <input type="hidden" class="form-control" name="total_weight" id="total_weight" readonly> 

                    <tr class="tableInfo"><td colspan="5" align="right"><strong>{{ trans('message.invoice.shipping_method') }}</strong></td><td align="left" colspan="2">
                    ...
                    <tr class="tableInfo" id="shipping_cost_div" style="display:none;"><td colspan="5" align="right"><strong>{{ trans('message.invoice.shipping_cost') }}</strong></td><td align="left" colspan="2">
                        <input type="text" class="form-control" name="shipping_cost" id="shipping_cost" readonly>
                    </td>
                    </tr>
                  <tr class="tableInfo"><td colspan="5" align="right"><strong>{{ trans('message.table.grand_total') }}({{Session::get('currency_symbol')}})</strong></td><td align="left" colspan="2"><input type='text' name="total" class="form-control" id = "grandTotal" readonly></td></tr>
                  </tbody>
                </table>
                </div>
                <br><br>
    ...
    $(document).on('keyup', '.unitprice', function(ev){
     ...
     $("#rowid"+id+" .taxAmount").text(taxByRow);
      ...
      $("#grandTotal").val(grandTotal);
        ...
        $(document).on('click', '#different_billing_address', function(){
