            ...
            <div class="col-md-12">
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                  ...
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.invoice.total_weight') }}</strong></td><td align="left" colspan="2"><input type="text" class="form-control" name="total_weight" id="total_weight" readonly> </td></tr>
