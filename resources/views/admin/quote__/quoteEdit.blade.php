...
@section('content')
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <input type="hidden" value="{{$quote_cust_info[0]->id}}" name="quote_id" id="">
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                 ...
                 <tr id="rowid_{{$quote_details->item_id}}">
                          ...
                          <td><input class="form-control text-center weight" type="text"  id="weight_{{$quote_details->item_id}}" value="{{$quote_details->item_weight}}" name="item_weight[]" readonly></td>

                          <td><input class="form-control text-center total_weight" type="text"  id="ttl_weight_{{$quote_details->item_id}}" value="{{$quote_details->item_weight *$quote_details->item_quantity }}" name="" readonly></td>
                  ...
                  @endforeach
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.table.sub_total') }}({{Session::get('currency_symbol')}})
                  </strong></td><td align="left" colspan="2"><input type="text" class="form-control" name="subtotal" value="<?php echo $sumsubtotal ?>" id="subTotal" readonly></td></tr>
                  
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.invoice.is_vat') }}</strong></td><td align="left" colspan="2">
                  ...
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.invoice.total_weight') }}</strong></td><td align="left" colspan="2"><input type="text" class="form-control" name="total_weight" value="{{$quote_cust_info[0]->total_weight}}" id="total_weight" readonly> </td></tr>

                    <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.invoice.shipping_method') }}</strong></td><td align="left" colspan="2">
                  ...
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.table.grand_total') }}({{Session::get('currency_symbol')}})</strong></td><td align="left" colspan="2"><input type='text' name="total" class="form-control" id = "grandTotal" value="{{$quote_cust_info[0]->total}}"  readonly></td></tr>
                  </tbody>
                </table>
                </div>
                <br><br>
