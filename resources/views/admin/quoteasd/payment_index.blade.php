...
@section('content')
    ...
    <div class="box box-default">
      <div class="box-body">
        <div class="row">
          <div class="col-md-9">
           <div class="top-bar-title padding-bottom">{{ trans('message.extra_text.quote_payments') }}</div>
          </div> 
          <div class="col-md-3">
            @if(!empty(Session::get('order_add')))
              <a href="{{ url('quote/payment_add') }}" class="btn btn-block btn-default btn-flat btn-border-orange"><span class="fa fa-plus"> &nbsp;</span>{{ trans('message.form.add_new_quote_method') }}</a>
            @endif
          </div>
        </div>
      </div>
