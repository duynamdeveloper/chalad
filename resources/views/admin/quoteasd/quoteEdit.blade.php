...
<div class="col-md-12">
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                 ...
                 <tr id="rowid_{{$quote_details->item_id}}">
                  ...
                  <tr class="tableInfo"><td colspan="6" align="right">
    ...
    <div class="col-md-4">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-8">
             <div class="top-bar-title">{{ trans('message.invoice.payment') }}</div>
            </div>
            <div class="col-md-4">
            ...
            <table class="table table-bordered" >
                      ...
                      @foreach($quote_payment as $quote_payment)
                        <tr>
                            ...
                            <td width="10%" class="text-center"><a href="{{url('uploads/Quote_recipt_Pic/'.$quote_payment->payment_image)}}">{{$quote_payment->payment_image}}</a></td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
       ...
       <form action="{{ url('save-quote_payment') }}" method="post" enctype="multipart/form-data" id="customerAdd" class="form-horizontal">
          ...
          <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
          <input type="hidden" name="invoice_reference" value="">
          <input type="hidden" name="order_reference" value="">
