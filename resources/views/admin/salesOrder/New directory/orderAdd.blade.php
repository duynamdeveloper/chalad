        ...
        <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">Search Customer (by phone)<span class="text-danger"> *</span></label>
                <select class="form-control select2" name="debtor_no" id="customer">
                <option value="">Search Customer or Create New</option>
            ...
            <div class="col-md-12">
              ...
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="purchaseInvoice">
                  ...
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.table.sub_total') }}({{Session::get('currency_symbol')}})</strong></td><td align="left" colspan="6"><strong id="subTotal"></strong></td></tr>
                  
                  <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.invoice.is_vat') }}</strong></td><td align="center" colspan="6"><input type="checkbox" name="is_vat" id="is_vat"></td></tr>

                 <input type="hidden" class="form-control" name="total_weight" id="total_weight" readonly> 

                    <tr class="tableInfo"><td colspan="6" align="right"><strong>{{ trans('message.invoice.shipping_method') }}</strong></td><td align="center" colspan="6">
                    ...
                    <tr class="tableInfo" id="shipping_cost_div" style="display:none;"><td colspan="6" align="right"><strong>{{ trans('message.invoice.shipping_cost') }}</strong></td><td align="left" colspan="2">
