    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li <?= $menu == 'sales' ? ' class="treeview active"' : 'treeview'?> >
          ...
          <ul class="treeview-menu">
            ...
            <li <?= isset($sub_menu) && $sub_menu == 'shipment/list' ? ' class="active"' : ''?> >
			  ...
			  <li <?= isset($sub_menu) && $sub_menu == 'shipping/cost' ? ' class="active"' : ''?> >
              <a href="{{url('shipping/cost')}}">
        ...
        <li <?= $menu == 'item' ? ' class="treeview active"' : 'treeview'?> >
		  ...
		  <li <?= isset($sub_menu) && $sub_menu == 'item-category' ? ' class="active"' : ''?> >
        ...
        <li <?= $menu == 'inventory' ? ' class="treeview active"' : 'treeview'?> >
          <a href="#">
            <i class="fa fa-list-ul"></i>
            <span>{{ trans('message.sidebar.inventory') }}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li <?= isset($sub_menu) && $sub_menu == 'inventory/inventory_view_adjust' ? ' class="active"' : ''?> >
              <a href="{{url('inventory/inventory_view_adjust')}}">
                <span>Inventory</span>
              </a>
            </li>

            <li <?= isset($sub_menu) && $sub_menu == 'inventory/adjust_history' ? ' class="active"' : ''?> >
              <a href="{{url('inventory/adjust_history')}}">
                <span>{{ trans('message.sidebar.inventory_adjust_history') }}</span>
              </a>
            </li>
            
            <li <?= isset($sub_menu) && $sub_menu == 'inventory/preoder' ? ' class="active"' : ''?> >
              <a href="{{url('inventory/preoder')}}">
        ...
        <!-- End of Inventory-->
		<li <?= $menu == 'supplier' ? ' class="treeview active"' : 'treeview'?> >
          <a href="#">
            <i class="fa fa-list-ul"></i>
            <span>Supplier</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
		<li <?= isset($sub_menu) && $sub_menu == 'inventory/purchases' ? ' class="active"' : ''?> >
            ...
            <li <?= isset($sub_menu) && $sub_menu == 'inventory/supplier_list' ? ' class="active"' : ''?> >
              <a href="{{url('supplier')}}">
                
                <span>{{ trans('message.sidebar.supplier_list') }}</span>
              </a>
            </li>
			</ul>
			</li>
